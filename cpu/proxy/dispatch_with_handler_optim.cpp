...
static int
_rpc_cudnncreatetensordescriptor_1 (ptr  *argp, void *result, struct svc_req *rqstp)
{
	return (rpc_cudnncreatetensordescriptor_1_svc(*argp, result, rqstp));
}
...
static int
_rpc_cudnncreatefilterdescriptor_1 (ptr  *argp, void *result, struct svc_req *rqstp)
{
	return (rpc_cudnncreatefilterdescriptor_1_svc(*argp, result, rqstp));
}
...
static int
_rpc_cudnncreateconvolutiondescriptor_1 (ptr  *argp, void *result, struct svc_req *rqstp)
{
	return (rpc_cudnncreateconvolutiondescriptor_1_svc(*argp, result, rqstp));
}
...
int dispatch(int proc_id, XDR *xdrs_arg, XDR *xdrs_res)
{
	union {
		...
		ptr rpc_cudnncreatetensordescriptor_1_arg;
		...
		ptr rpc_cudnncreatefilterdescriptor_1_arg;
		...
		ptr rpc_cudnncreateconvolutiondescriptor_1_arg;
	...
	union {
		...
		int rpc_cudnncreatetensordescriptor_1_res;
		...
		int rpc_cudnncreatefilterdescriptor_1_res;
		...
		int rpc_cudnncreateconvolutiondescriptor_1_res;
