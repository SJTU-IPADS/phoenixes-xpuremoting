...
/*        ptr_result   rpc_hidden_get_device_ctx(int)                            = 1101;
        ...
        int         rpc_cudnnCreateTensorDescriptor(ptr tensorDesc) = 5010;
        ...
        */
        ...
        int         rpc_cudnnCreateFilterDescriptor(ptr filterDesc) = 5041;
        ...
        /* cudnn cnn inference */
        int         rpc_cudnnCreateConvolutionDescriptor(ptr convDesc) = 5301;
